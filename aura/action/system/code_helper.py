...
from aura.action._api_config import get_gemini_key, call_local_llm, use_local_llm
...
def _get_model():
    """Get LLM model - prefers local, falls back to Gemini."""
    if use_local_llm():
        return None  # Signal to use local
...
def _complete(prompt: str) -> str:
    ...
    response_text = _complete(prompt)
